...
delayR region ciudad1 ciudad2 | (verifyC region ciudad1) && (verifyC region ciudad2) = distanceC ciudad1 ciudad2 | otherwise = error"Una o mas de las ciudades no pertenecen a esta region"
